...
export type CollectionProductMoneyFragment = Pick<
...
export type CollectionTotalProductsQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type CollectionTotalProductsQuery = {
  collection?: StorefrontAPI.Maybe<{
    products: {nodes: Array<Pick<StorefrontAPI.Product, 'id'>>};
  }>;
};

export type CollectionFilterFragment = {
  filters: Array<
...
type ProductPreviewMedia_ExternalVideo_Fragment = Pick<
...
type ProductPreviewMedia_MediaImage_Fragment = Pick<
...
type ProductPreviewMedia_Model3d_Fragment = Pick<
...
type ProductPreviewMedia_Video_Fragment = Pick<
  StorefrontAPI.Video,
  'id' | 'mediaContentType' | 'alt'
> & {
  previewImage?: StorefrontAPI.Maybe<
...
export type ProductPreviewMediaFragment =
  | ProductPreviewMedia_ExternalVideo_Fragment
  | ProductPreviewMedia_MediaImage_Fragment
  | ProductPreviewMedia_Model3d_Fragment
  | ProductPreviewMedia_Video_Fragment;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CollectionTotalProducts(\n    $handle: String!\n  ) {\n    collection(handle: $handle) {\n      products(first: 250) {\n        nodes {\n          id\n        }\n      }\n    }\n  }\n': {
    return: CollectionTotalProductsQuery;
    variables: CollectionTotalProductsQueryVariables;
  };
